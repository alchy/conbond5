...
| `cb5/ground.py` | čtení → paměť: identita jmen (celé jméno, viděné tvary, třída↔jméno, titul; **„Petr má bratra Karla“ → Karel ∈ bratr⟨Petr⟩**, u koordinovaného podmětu ke každému), instance z neurčité zmínky, pro‑drop/zájmena (aktivace, téma dokumentu), přivlastnění, otevřené položky |
...
| testy / typy | — | 113 pytest, mypy čistý |
